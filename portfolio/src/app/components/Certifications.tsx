        ...
        >
          ...
          >
            <a className="" href={siteUrl} target="_blank">
              <Image
                className="rounded-md shadow-lg hover:border border-solid border-white-500 border-opacity-30"
                src={logo}
                alt="Course logo"
              />
            </a>
          ...
          <div className="flex flex-col pb-3 items-start col-span-5">
            <div className="text-2xl">
              ...
              <p className="text-xs md:text-md text-white-500 capitalize py-1">
                {time}
              </p>
            </div>
...
const Certifications = () => {
  ...
  return (
    <>
      <section
        className="border-solid border-b border-dark-500 pb-28 lg:p b-16 relative z-10 "
        id="certification"
      >
